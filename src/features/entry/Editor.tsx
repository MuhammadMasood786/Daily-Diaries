...
import { setCanEdit, setCurrentEditing } from "./editorSlice";
...
const Editor: FC = () => {
    const { activeDiaryId, canEdit, currentlyEditing: entry } = useSelector((state: RootState) => state.editor)
    const [editedEntry, updateEditedEntry] = useState(entry)
    const dispatch = useAppDispatch()

    const saveEntry = async () => {
        if (activeDiaryId == null) {
            return showAlert('Please selected a diary', 'warning')
        }
            ...
            http
                ...
                .then((data) => {
                    if (data != null) {
                        ...
                        dispatch(setCurrentEditing(_entry))
